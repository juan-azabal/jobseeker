...
# _heuristic_gate moved to agent/scoring.py
...
# --- Scoring globals and heuristic functions (agent/scoring.py) ---
import scoring as _scoring_mod  # live module reference so _is_reloc etc read updated globals
...
from scoring import (  # noqa: E402
    ...
    heuristic_gate as _heuristic_gate,
)
...
# --- Reloc detection (agent/reloc.py) ---
from reloc import (  # noqa: E402
    is_remote_requiring_reloc as _is_remote_requiring_reloc,
    is_reloc as _is_reloc,
)


# --- Display, ranking, auto-skip (agent/display.py) ---
from display import (  # noqa: E402
    ranked_jobs,
    print_summary,
    auto_skip_reloc as _auto_skip_reloc,
)
