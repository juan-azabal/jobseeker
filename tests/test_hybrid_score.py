...
class TestHybridScoreGradeImpact:
    ...
    def test_grade_a_b_higher_than_b_c(self):
        score_ab = hybrid_score(_PROFILE, _PARSED, _JOB, False,
                                technical_grade="A", profile_grade="B")
        score_bc = hybrid_score(_PROFILE, _PARSED, _JOB, False,
                                technical_grade="B", profile_grade="C")
    ...
    def test_grade_a_a_adds_40_vs_no_grades(self):
        ...
        with_aa = hybrid_score(_PROFILE, _PARSED, _JOB, False,
                               technical_grade="A", profile_grade="A")
    ...
    def test_grade_c_c_adds_10_vs_no_grades(self):
        ...
        base = hybrid_score(_PROFILE, _PARSED, _JOB, False)
        with_cc = hybrid_score(_PROFILE, _PARSED, _JOB, False,
                               technical_grade="C", profile_grade="C")
    ...
    def test_none_grades_are_neutral_midpoint(self):
        ...
        score_none_explicit = hybrid_score(_PROFILE, _PARSED, _JOB, False,
...
class TestHybridScoreReturnBounds:
    ...
    def test_score_not_exceeds_100(self):
        ...
        score = hybrid_score(profile_maxed, _PARSED, _JOB, False,
                             technical_grade="A", profile_grade="A")
        assert score <= 100

    def test_score_not_below_zero(self):
        parsed_with_flags = {**_PARSED, "red_flags": ["x"] * 5}
        score = hybrid_score(_PROFILE, parsed_with_flags, _JOB, False,
                             technical_grade="C", profile_grade="C")
        assert score >= 0
...
class TestHybridScoreSignature:
    ...
    def test_accepts_domain_override(self):
        ...
        score = hybrid_score(_PROFILE, _PARSED, _JOB, False,
                             domain_override="saas",
    ...
    def test_lowercase_grades_accepted(self):
        ...
        score_upper = hybrid_score(_PROFILE, _PARSED, _JOB, False,
                                   technical_grade="A", profile_grade="B")
        score_lower = hybrid_score(_PROFILE, _PARSED, _JOB, False,
                                   technical_grade="a", profile_grade="b")
