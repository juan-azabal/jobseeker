...
## Deployment
- **PRs are always squash-merged** (enforced in GitHub repo settings — merge commits and rebase disabled). One PR = one commit on main = one Railway deploy. Branch commits are intermediate checkpoints only.
